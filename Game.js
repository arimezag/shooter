...
class Game {
    ...
    updateScoreDisplay() {
        const scoreDisplay = document.getElementById('scoreli');
        if (scoreDisplay) {
    ...
    */
     ...
     */
     removeOpponent () {
        ...
        // Si el jefe aún no ha sido generado, generar el jefe
        if (!this.bossSpawned) {
    ...
    */
     ...
     */
     endGame() {
        ...
        // Si el jefe ha sido derrotado (opponent es undefined) y el jugador tiene más de 0 vidas
        if (this.bossSpawned && this.opponent === undefined && this.player.lives > 0) {
            imageSrc = 'assets/you_win.png';
        } else {
            imageSrc = 'assets/game_over.png';
        }
        let gameEnd = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, imageSrc);
        gameEnd.render();
    }
